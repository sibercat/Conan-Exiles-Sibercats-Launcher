Executable can be found in [Releases](https://github.com/sibercat/SibercatsLauncher/releases) If your going to use .exe executable was created by PyInstaller so you could get a false positive, you know the deal.
